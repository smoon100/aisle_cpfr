...
@synthesize webView;
@synthesize path;
@synthesize pathOnPrinter;
@synthesize storeSelected;
...
-(NSString*) extendFileName:(NSString*)name withPageNumber:(NSInteger)pageNumber{
	NSString *pageNumberAsString = [NSString stringWithFormat:@"%d", pageNumber];
	...
	NSString *truncatedFileName = [fileNameWithoutDrive substringToIndex:fileNameLength];
