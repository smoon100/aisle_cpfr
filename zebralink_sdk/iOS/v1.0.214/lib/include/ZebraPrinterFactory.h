 ...
 * <c>error.code</c> will be \link ZebraErrorCodeInterface::ZEBRA_ERROR_NO_CONNECTION ZEBRA_ERROR_NO_CONNECTION\endlink if the connection was not open.
 * <c>error.code</c> will be \link ZebraErrorCodeInterface::ZEBRA_UNKNOWN_PRINTER_LANGUAGE ZEBRA_UNKNOWN_PRINTER_LANGUAGE\endlink if the <c>appl.name</c> SGD value could not be obtained from the printer.
